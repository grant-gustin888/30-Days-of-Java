...
const compose = function (functions) {
    return function (value) {
        // Approach 1: using for loop and indexing the array in reverse
        let composedFunction = (x => x)(value);
        for (let i = functions.length - 1; i >= 0; i--) {
            composedFunction = functions[i](composedFunction);
        }
        return composedFunction;

        // Approach 2: using a for-of loop, plus the reverse() method
        // let composedFunction = (x => x)(value);
        // for (const fn of functions.reverse()) {
        //     composedFunction = fn(composedFunction);
        // }
        // return composedFunction;

        // Approach 3: using a for-in loop, plus the reverse() method
        // let composedFunction = (x => x)(value);
