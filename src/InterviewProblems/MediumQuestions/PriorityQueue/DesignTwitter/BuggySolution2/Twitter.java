package InterviewProblems.MediumQuestions.PriorityQueue.DesignTwitter.BuggySolution2;
...
public class Twitter {
    ...
    public Twitter() {
        ...
        newsFeed = new PriorityQueue<>((tweet1, tweet2) -> {
            int tweet1Timestamp = tweet1.timestamp;
            int tweet2Timestamp = tweet2.timestamp;
    ...
    public List<Integer> getNewsFeed(int userId) {
        ...
        while (!newsFeed.isEmpty() && tweetsExtractedSoFar.size() < NUM_MOST_RECENT_TWEETS) {
