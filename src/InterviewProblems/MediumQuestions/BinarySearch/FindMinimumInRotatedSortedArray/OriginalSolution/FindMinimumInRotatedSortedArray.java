package InterviewProblems.MediumQuestions.BinarySearch.FindMinimumInRotatedSortedArray.OriginalSolution;
...
public class FindMinimumInRotatedSortedArray {
    ...
    public int findMin(int[] nums) {
        ...
        while (leftIndex <= rightIndex) {
            ...
            } else {  // nums[middleIndex] < nums[leftIndex] and nums[leftIndex] > nums[rightIndex]
                rightIndex = middleIndex;
            }
        }
        return Integer.MIN_VALUE;  // this should never happen... there must be a minimum element in a non-empty list.
    }
}
